...
class Router
{
    ...
    {
        // Escape forward slashes: Replacing / with \/
    ...
    {
        /*
        // Match to each entry in the routing table using simple string comparsion
        ...
        */
        ...
        // Match to the fixed URL format /controller/action using regex
    ...
    /**
     * Convert the string with the hyphens to camelCase,
     * e.g. add-new => addNew
     *
     * @param string $string The string to convert
     *
